...
config :nfd,
  ...
  seven_week_vol_1_day_0_title: "Introduction",
  ...
  seven_week_vol_2_day_0_title: "Introduction",
  ...
  seven_week_vol_3_day_0_title: "Introduction",
  ...
  seven_week_vol_4_day_0_title: "Introduction",
