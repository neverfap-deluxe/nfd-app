defmodule NfdWeb.Endpoint do
  ...
  # HOWEVER DO NOT put it in the "priv/static" directory. Put it in "/assets/static"
  # yes
  ...
  plug Plug.Static,
    ...
    from: :nfd,
    gzip: true,
    only: ~w(css fonts images sitemaps ebooks js favicon.ico robots.txt podcast.xml)
