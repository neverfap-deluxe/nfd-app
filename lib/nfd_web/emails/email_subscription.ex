defmodule NfdWeb.EmailSubscription do
  ...
  def validate_matrix_element(matrix) do
    Enum.map(String.split(matrix, "-"), fn(matrix_element) ->
      IO.inspect matrix_element
      case String.split(matrix_element, "+") do
  ...
  def update_subscription(subscriber, matrix) do 
