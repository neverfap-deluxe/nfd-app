defmodule NfdWeb.DashboardController do
  ...
  def dashboard_course_collection(conn, %{"collection" => collection_slug}), do: Fetch.fetch_dashboard_collection(conn, :dashboard_course_collection, collection_slug, "", FetchAccess.fetch_access_array(:dashboard_course_collection))
  def dashboard_course_file(conn, %{"collection" => collection_slug, "file" => file_slug}), do: Fetch.fetch_dashboard_file(conn, :dashboard_course_file, collection_slug, file_slug, FetchAccess.fetch_access_array(:dashboard_course_file))
  ...
  def dashboard_ebook_collection(conn, %{"collection" => collection_slug}), do: Fetch.fetch_dashboard_collection(conn, :dashboard_ebook_collection, collection_slug, "", FetchAccess.fetch_access_array(:dashboard_ebook_collection))
  def dashboard_ebook_file(conn, %{"collection" => collection_slug, "file" => file_slug}), do: Fetch.fetch_dashboard_file(conn, :dashboard_ebook_file, collection_slug, file_slug, FetchAccess.fetch_access_array(:dashboard_ebook_file))
