  ...
  def generate do
    ...
    do
      create do
        ...
        add Helpers.page_path(Endpoint, :guides_curriculum), priority: 0.5, changefreq: "weekly", expires: nil
        add Helpers.page_path(Endpoint, :guides_fundamental_meditation_series), priority: 0.5, changefreq: "weekly", expires: nil
        # GUIDES END
