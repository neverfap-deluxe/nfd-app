...
#       add Helpers.page_path(Endpoint, :disclaimer), priority: 0.5, changefreq: "daily", expires: nil
#       add Helpers.page_path(Endpoint, :privacy), priority: 0.5, changefreq: "daily", expires: nil
#       add Helpers.page_path(Endpoint, :account), priority: 0.5, changefreq: "daily", expires: nil

#       add Helpers.page_path(Endpoint, :articles), priority: 0.5, changefreq: "daily", expires: nil
#       add Helpers.page_path(Endpoint, :practices), priority: 0.5, changefreq: "daily", expires: nil
#       add Helpers.page_path(Endpoint, :courses), priority: 0.5, changefreq: "daily", expires: nil
#       add Helpers.page_path(Endpoint, :podcasts), priority: 0.5, changefreq: "daily", expires: nil
